...
- **DO NOT** edit, modify, or commit changes to files within submodule directories (e.g., `lightly-train/`, `chicken-detection-labelme-format/`)
...
# 3. Run training script (uv will use the venv automatically)
...
# Example: Run GPU memory management utility
